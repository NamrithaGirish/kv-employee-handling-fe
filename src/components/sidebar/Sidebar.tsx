            ...
            <nav className="nav-bar">   
                <ul className="emp-list">
                   <li> 
                    ...
                    <Button text="Employee List" classname="logout" type={"button"} functionName={()=>{navigate("/employee")}} />
                    </li>
                    <li> 
                    <img src={createEmployeeImage} />
                   
                    <Button text="Create Employee" classname="logout" type={"button"} functionName={()=>{navigate("/employee/create")}} /></li>
                    <li> 
                    <img src={createEmployeeImage} />
                   
                    <Button text="Log Out" classname="logout" type={"button"} functionName={handleLogout} /></li>
                </ul>
            </nav>
    </div>
    )
