...
export const DisplayAllEmployees=()=>{
    ...
    const title=["Employee Name","Employee ID","Joining Date","Role","status","Experience","Action"]
    const data =[
    {
        "id": 75,
           ...
           <div className="emp-list-header">
                <Header title="Employee List" >
                    <div className="edit-option-status">
                        <OptionsField classname="edit-status-in-view" label="" options={["ALL","ACTIIVE","INACTIVE","PROBATION"]} noDisabledField={true} onChange={(e:React.ChangeEvent<HTMLSelectElement>)=>{setSearchParams(e.target.value)}}/>
                    </div>
                    <div className="edit-option">
                        <button className="edit-button-in-view" onClick={navigateToCreateEmployeePage}>
                            {/* <div className="edit-icon-in-view">
                                +
                            </div> */}
                ...
                {/* <Button text="SET" classname="param-get" functionName={setSearchParamsButton}/>
